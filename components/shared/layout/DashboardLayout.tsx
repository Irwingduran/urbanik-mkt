...
const useNotifications = () => {
  // En producción, esto debería venir de una API o Context
  const [notifications, setNotifications] = React.useState<Notification[]>([
    {
      id: 1,
      type: NotificationType.SUCCESS,
      title: 'Orden Entregada',
      message: 'Tu pedido #ORD-001 ha sido entregado',
      time: 'hace 2 horas',
      read: false
    },
    {
      ...
      message: 'Hay nuevas características disponibles en el dashboard',
      time: 'hace 1 día',
      read: false
    },
    {
      ...
      message: 'Completa tu perfil para desbloquear más beneficios',
      time: 'hace 2 días',
      read: true
    }
  ])
...
const Sidebar: React.FC<{
  ...
  const showVendorBanner = session.user.role !== UserRole.VENDOR && 
